# Contributing to amex-jest-preset
...
1. Fork the repository `amex-jest-preset` to your GitHub account.
2. Afterwards run the following commands in your terminal

    ```bash
    $ git clone https://github.com/<your-github-username>/amex-jest-preset
    $ cd amex-jest-preset
    ```
...
- Version of amex-jest-preset: [e.g. 5.0.0]
